...
(val leftArg: L, val opString : String, val rightArg: R)(_width : Int) (
  ...
  final protected[DFiant] lazy val leftBalanceLB : LazyBox[Pipe] = LazyBox.Args2[Pipe, Pipe, Pipe](this)((l, r) => l - r, pipeInletLB, leftArg.pipeOutletLB)
  final protected[DFiant] lazy val rightBalanceLB : LazyBox[Pipe] = LazyBox.Args2[Pipe, Pipe, Pipe](this)((l, r) => l - r, pipeInletLB, rightArg.pipeOutletLB)
