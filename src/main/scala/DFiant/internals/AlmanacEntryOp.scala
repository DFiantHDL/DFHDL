...
class AlmanacEntryOp private (outWidth : Int, opString : String, val init : Seq[Token], val args : Seq[AlmanacEntry], codeStringBld : String => String, refCodeStringBld : String => String)(implicit almanac : Almanac) extends AlmanacEntry {
