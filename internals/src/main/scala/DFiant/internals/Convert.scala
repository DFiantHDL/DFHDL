...
object ~ :
  ...
  transparent inline given [Of, F <: Of]: Conversion[Of, F] =
    new Conversion[Of, F] {
      type To = F
  ...
  protected trait LowPriority:
    transparent inline given [Of, From]: WorkAround[Of, From] =
      new WorkAround[Of, From] { type To = Nothing }
  protected object WorkAround extends LowPriority:
    transparent inline given [Of, From](using
