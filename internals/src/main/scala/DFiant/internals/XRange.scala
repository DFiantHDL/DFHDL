...
object XRange {
  ...
  protected object Int {
    ...
    def TO[Start <: std.Int, End <: std.Int](
        start: Start,
        end: End
    ): TO[Start, End] = Range(start, end).asInstanceOf[TO[Start, End]]
    type DOWNTO[Start <: std.Int, End <: std.Int] = Int[Start, End]
      with XRange.DOWNTO
    def DOWNTO[Start <: std.Int, End <: std.Int](
        start: Start,
        end: End
    ): DOWNTO[Start, End] =
      Range(start, end, -1).asInstanceOf[DOWNTO[Start, End]]
  ...
  protected object Long {
    type TO[Start <: std.Long, End <: std.Long] = Long[Start, End]
      with XRange.TO
    def TO[Start <: std.Long, End <: std.Long](
        start: Start,
        end: End
    ): TO[Start, End] = Range.Long(start, end, 1L).asInstanceOf[TO[Start, End]]
    type DOWNTO[Start <: std.Long, End <: std.Long] = Long[Start, End]
      with XRange.DOWNTO
    def DOWNTO[Start <: std.Long, End <: std.Long](
        start: Start,
        end: End
    ): DOWNTO[Start, End] =
      Range.Long(start, end, -1L).asInstanceOf[DOWNTO[Start, End]]
  ...
  trait Implicits {
    sealed class XRangefromInt[Start <: std.Int](start: Start) {
      def TO[End <: std.Int, S <: std.Int, E <: std.Int](end: End)(implicit
          s: OpAuxGen[AcceptNonLiteral[GetLHSArg0], S],
      ...
      def UNTIL[End <: std.Int, S <: std.Int, E <: std.Int](end: End)(implicit
          s: OpAuxGen[AcceptNonLiteral[GetLHSArg0], S],
      ...
      def DOWNTO[End <: std.Int, S <: std.Int, E <: std.Int](end: End)(implicit
          s: OpAuxGen[AcceptNonLiteral[GetLHSArg0], S],
          e: OpAuxGen[AcceptNonLiteral[GetArg0], E],
      ...
      def DOWNTIL[End <: std.Int, S <: std.Int, E <: std.Int](end: End)(implicit
          s: OpAuxGen[AcceptNonLiteral[GetLHSArg0], S],
          e: OpAuxGen[AcceptNonLiteral[GetArg0 + 1], E],
          check: Int.Check.CheckedShell[E, S]
      ): Int.DOWNTO[S, E] = {
    ...
    final implicit def XRangefromInt[Start <: std.Int](
        start: Start
    ): XRangefromInt[Start] = new XRangefromInt(start)

    sealed class XRangefromLong[Start <: std.Long](start: Start) {
      def TO[End <: std.Long, S <: std.Long, E <: std.Long](end: End)(implicit
          s: OpAuxGen[AcceptNonLiteral[GetLHSArg0], S],
          e: OpAuxGen[AcceptNonLiteral[GetArg0], E],
    ...
    final implicit def XRangefromLong[Start <: std.Long](
        start: Start
    ): XRangefromLong[Start] = new XRangefromLong(start)
  }
}
