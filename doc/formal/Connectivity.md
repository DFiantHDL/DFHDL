...
![1531312790115](C:\IdeaProjects\DFiant\doc\formal\graphics\1541501671111.png)
...
| Shape                                                        | Meaning                                                      |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![1541510366894](C:\IdeaProjects\DFiant\doc\formal\graphics\1541510366894.png)or ![1541510402440](C:\IdeaProjects\DFiant\doc\formal\graphics\1541510402440.png) | A dataflow design                                            |
| ![1541510440673](C:\IdeaProjects\DFiant\doc\formal\graphics\1541510440673.png) | A dataflow port. <br />Arrow enters a dataflow design shape = INPUT port<br />Arrow exists a dataflow design shape = OUTPUT port |
| ![1541510499046](C:\IdeaProjects\DFiant\doc\formal\graphics\1541510499046.png) | A dataflow variable (mutable)                                |
| ![1541510546268](C:\IdeaProjects\DFiant\doc\formal\graphics\1541513593500.png) | A constant (immutable literal). <br />In this case, the value is 5. |
| ![1541510762069](C:\IdeaProjects\DFiant\doc\formal\graphics\1541510762069.png) | A dataflow join calculation junction (immutable). <br />In this case, the calculation is the addition `+` arithmetic operation. |
| ![1541520934186](C:\IdeaProjects\DFiant\doc\formal\graphics\1541520934186.png) | A dataflow state element, via `.prev(rank)` (immutable).<br />In this case, the rank is 3. |
| ![1541511506371](C:\IdeaProjects\DFiant\doc\formal\graphics\1541511506371.png) | A single-line arrow indicates a dataflow dependency<br />**assignment** from a producer (arrow tail) to a <br />consumer (arrow head) |
| ![1541511626760](C:\IdeaProjects\DFiant\doc\formal\graphics\1541511626760.png) | A double-line <u>diamond</u> arrow indicates a dataflow dependency<br />**connection** from a producer (arrow tail) to a <br />consumer (arrow head) **and** an initial conditions dependency |
| ![1541513485972](C:\IdeaProjects\DFiant\doc\formal\graphics\1541513485972.png) | A double-line arrow indicates a dataflow dependency<br />**reference** from a producer (arrow tail) to a <br />consumer (arrow head) **and** an initial conditions dependency |
...
| ----------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| Code                                | ![1541486481167](C:\IdeaProjects\DFiant\doc\formal\graphics\1541486481167.png) | ![1541486548350](C:\IdeaProjects\DFiant\doc\formal\graphics\1541486548350.png) |
| Functional<br />Diagram             | ![1531354461853](C:\IdeaProjects\DFiant\doc\formal\graphics\1541501701314.png) <br />We use a double line arrow to indicate a dataflow dependency **with** an initial condition dependency. | ![1531312715988](graphics/1531314030378.png)<br />We use a single line arrow to indicate a dataflow dependency **without** affecting initial conditions of the consumer. |
...
![1531314589019](C:\IdeaProjects\DFiant\doc\formal\graphics\1541502098181.png)
...
A connection `<>` transfers initial conditions to the consumer and overrides any existing initial conditions of the consumer (opposed to an assignment, which does not affect initial conditions). Here is an example:
...
trait TopInit extends DFDesign {
  val i = DFUInt(8) <> init (1, 2) 	//init = (1, 2)   The top-level initial conditions
  val o = DFUInt(8) <> init 1     	//init = (5)		  Overriden from io.o
...
![1541618117728](C:\IdeaProjects\DFiant\doc\formal\graphics\1541618117728.png)
...
![1541633749924](C:\IdeaProjects\DFiant\doc\formal\graphics\1541633749924.png)
...
![1541525350659](C:\IdeaProjects\DFiant\doc\formal\graphics\1541603175175.png)
...
![1531312715988](C:\IdeaProjects\DFiant\doc\formal\graphics\1541501963343.png)
...
![1531313031884](C:\IdeaProjects\DFiant\doc\formal\graphics\1541502005694.png)
...
![1531313204197](C:\IdeaProjects\DFiant\doc\formal\graphics\1541501792059.png)
...
![1531313619621](C:\IdeaProjects\DFiant\doc\formal\graphics\1541502049075.png)
...
![1531322811065](C:\IdeaProjects\DFiant\doc\formal\graphics\1541502127823.png)
...
![1531344446287](C:\IdeaProjects\DFiant\doc\formal\graphics\1541502151965.png)
...
![1531345077704](C:\IdeaProjects\DFiant\doc\formal\graphics\1541609861696.png)
