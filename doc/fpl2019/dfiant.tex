...
\begin{table*}[t!]
  ...
  \begin{minipage}[t][23cm][t]{0.46\linewidth}
    \centering
    \captionsetup{justification=centering}    \begin{minted}[xleftmargin=1.5em,linenos,autogobble,tabsize=2,framesep=1pt, frame=single,fontsize=\fontsize{8}{9}\selectfont]{scala}
      import DFiant._
