...
module cipher_0(
  ...
  assign state_00_key                   = '{3: keySchedule_o[3], 2: keySchedule_o[2], 1: keySchedule_o[1], 0: keySchedule_o[0]};
  ...
  assign state_01_key                   = '{3: keySchedule_o[7], 2: keySchedule_o[6], 1: keySchedule_o[5], 0: keySchedule_o[4]};
  ...
  assign state_02_key                   = '{3: keySchedule_o[11], 2: keySchedule_o[10], 1: keySchedule_o[9], 0: keySchedule_o[8]};
  ...
  assign state_03_key                   = '{3: keySchedule_o[15], 2: keySchedule_o[14], 1: keySchedule_o[13], 0: keySchedule_o[12]};
  ...
  assign state_04_key                   = '{3: keySchedule_o[19], 2: keySchedule_o[18], 1: keySchedule_o[17], 0: keySchedule_o[16]};
  ...
  assign state_05_key                   = '{3: keySchedule_o[23], 2: keySchedule_o[22], 1: keySchedule_o[21], 0: keySchedule_o[20]};
  ...
  assign state_06_key                   = '{3: keySchedule_o[27], 2: keySchedule_o[26], 1: keySchedule_o[25], 0: keySchedule_o[24]};
  ...
  assign state_07_key                   = '{3: keySchedule_o[31], 2: keySchedule_o[30], 1: keySchedule_o[29], 0: keySchedule_o[28]};
  ...
  assign state_08_key                   = '{3: keySchedule_o[35], 2: keySchedule_o[34], 1: keySchedule_o[33], 0: keySchedule_o[32]};
  ...
  assign state_09_key                   = '{3: keySchedule_o[39], 2: keySchedule_o[38], 1: keySchedule_o[37], 0: keySchedule_o[36]};
  ...
  assign state_10_key                   = '{3: keySchedule_o[43], 2: keySchedule_o[42], 1: keySchedule_o[41], 0: keySchedule_o[40]};
  assign o                              = state_10_o;
endmodule
