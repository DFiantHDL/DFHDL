...
object matmulBlockApp extends App {
  ...
  top.printCodeString.compile.printCodeString.toFile("matmulBlock/zedboard/matmul_ait/xilinx/HLS/loopback/solution1/impl/ip/hdl/vhdl/matmulBlock_moved.vhd")
}
