...
class DFTupleSpec extends DFSpec:
  val tplA = (DFUInt(8), Bit, DFBits(3))
  val tplB = ((DFUInt(8), Bit), DFBits(3))
  ...
  assertCodeString(
    """|val t1 = (DFUInt(8), Bit, DFBits(3)) <> VAR init ((d"8'0", 1, b"000"), (d"8'22", 0, b"101"))
       |val t2 = ((DFUInt(8), Bit), DFBits(3)) <> VAR init ((d"8'11", 1), b"010")
       |val t3 = ((DFUInt(8), Bit), DFBits(3)) <> VAR init ((d"8'22", 1), b"101")
       |val t4 = ((DFUInt(8), Bit), DFBits(3)) <> VAR init ((?, ?), b"???")
       |t3 := ((d"8'22", 1), b"101")
       |t3 := ((d"8'11", 1), b"010")
       |t4 := t3
       |val t5 = t3 == t4
       ...
       |val t8 = (DFUInt(8), Bit, DFBits(3)) <> VAR init (d"8'22", 0, b"100")
       |val t9 = (DFUInt(8), Bit, DFBits(3), Boolean) <> VAR
       |val t10 = t1._1
       |val t11 = !t2._1._2
       |val t12 = t9(0)
       |""".stripMargin
  ) {
    val t1: (DFUInt[8], Bit, DFBits[3]) <> VAL =
      tplA <> VAR init ((0, 1, all(0)), (22, 0, b"101"))
    val t2: ((DFUInt[8], Bit), DFBits[3]) <> VAL =
    ...
    val b3 = DFBits(3) <> VAR
    val t7 = t3 == ((d"8'11", 1), b3)
    val t8: (DFUInt[8], Bit, DFBits[3]) <> VAL =
