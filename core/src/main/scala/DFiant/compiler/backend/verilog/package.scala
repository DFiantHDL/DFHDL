...
package object verilog {
  ...
  private implicit def compiler[D <: DFDesign, C](c: C)(implicit
  ...
  implicit object v95 extends BackendStage.Compiler[Backend[Revision.V95]] {
    def apply[D <: DFDesign](
        c: IRCompilation[D]
    ): BackendStage.Compilation[D, Backend[Revision.V95]] =
      c.verilogCompile[Revision.V95]
  }
  implicit object v2001 extends BackendStage.Compiler[Backend[Revision.V2001]] {
    def apply[D <: DFDesign](
        c: IRCompilation[D]
    ): BackendStage.Compilation[D, Backend[Revision.V2001]] =
      c.verilogCompile[Revision.V2001]
  }
