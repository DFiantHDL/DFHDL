...
package object vhdl {
  ...
  implicit object v93 extends BackendStage.Compiler[Backend[Revision.V93]] {
    def apply[D <: DFDesign](
        c: IRCompilation[D]
    ): BackendStage.Compilation[D, Backend[Revision.V93]] =
      c.vhdlCompile[Revision.V93]
  }
  implicit object v2008 extends BackendStage.Compiler[Backend[Revision.V2008]] {
    def apply[D <: DFDesign](
        c: IRCompilation[D]
    ): BackendStage.Compilation[D, Backend[Revision.V2008]] =
      c.vhdlCompile[Revision.V2008]
  }
