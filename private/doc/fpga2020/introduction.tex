...
\sect{sec:evaluation} describes our evaluation of the DFiant language and compiler, and, finally, \sect{sec:conclusion} concludes the paper and proposes further research trajectories.
