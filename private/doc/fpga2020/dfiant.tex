...
Dataflow designs makeup the basic hierarchy blocks in DFiant. By extending the abstract class \code{DFDesign} the designer populates it with IO ports that makeup its interface and dataflow variables and logic that makeup its implementation.
