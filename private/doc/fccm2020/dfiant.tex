...
\begin{figure*}[t!]
  ...
  \begin{minipage}[b][10.8cm][t]{0.32\linewidth}
    ...
    \end{minted}
    \captionof{subfigure}{The MA4 DFiant code \\ Concise and portable}
    \label{fig:MADFiant}
  \end{minipage}%
  \hfill
...
%    }
  ...
  \captionsetup{justification=centering}      
  \caption{
		The MA4, presented in three forms (the inputs are \code{a}, \code{b}, \code{c}, \code{d} and the output is \code{o}) \\ 
