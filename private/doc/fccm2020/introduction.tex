...
The remainder of this paper is organized as follows. The next section details the motivation behind the dataflow HDL abstractions, and \sect{sec:dfiant} provides a general overview of the DFiant HDL language. 
\sect{sec:compiler} briefly outlines the main DFiant compiler operations.
\sect{sec:evaluation} describes our evaluation of the DFiant language and compiler, and, finally, \sect{sec:conclusion} concludes the paper and discusses future work.
